...
<p>Read the <a href="agent-lab.html">companion code guide</a> and run <code>python -m agent_lab.order_demo</code> from the repository root. The <a href="https://github.com/az9713/agent-systems-foundations/blob/main/tests/test_agent_lab.py">behavioral checks</a> cover the permission gate, state race, uncertain commit, context arithmetic, and memory scope. The current four chapters form a working educational harness; later course topics can extend it. It is not a production runtime or a provider-specific integration.</p>
<h2 id="sources">Role of CMU 11-768</h2>
<p>These chapters use the <em>contents</em> of the first four recorded lectures of <a href="https://www.cmu-agents.com/">CMU 11-768: AI Agents</a>, not merely the syllabus. The recordings supply the order of topics and substantive starting material: the agent interaction loop and the training-versus-harness distinction; code as a tool and constrained tool-call formats; attention, caching, and compaction; and authored and learned skills. Specific lecture examples also informed the chapters. The grocery-cart task in Chapter 2, for instance, comes from the <a href="https://www.youtube.com/watch?v=jXChFB4JSyw&amp;t=596s">tool-use lecture</a>. These ideas are re-explained and extended in independently written textbook prose, rather than reproduced as a transcript.</p>
...
<p>There are 27 numbered main sections across the four chapters. Twenty-five link to a relevant point in a recording: 6/7 in Chapter 1, 7/7 in Chapter 2, 6/6 in Chapter 3, and 6/7 in Chapter 4. The two untimed sections synthesize material developed in the chapters. Thus 25/27 measures <em>section-level navigation back to lecture topics</em>. It does not mean that 25/27 of the prose, claims, mathematics, or code came from CMU. A defensible content-share estimate would require a claim-level ledger: divide each chapter into explanatory claims, examples, derivations, and code blocks; record for each whether its content is explicitly present in a recording or slide, expands a lecture topic, comes from an independently cited source, or is an original teaching construction; then publish the counts and source pointers for every category. Such a ledger has not yet been completed, so no percentage of substantive reuse is claimed.</p>
<p>The <a href="sources/manifest.json">source manifest</a> records the four recordings used for this edition as of 12 September 2026. Their English captions were automatically generated, so technical terms were cross-checked against course slides and primary research sources. Timestamps identify a relevant segment; they do not attribute every statement under a heading to an instructor. The <a href="https://www.youtube.com/playlist?list=PLSN0qpDfUvTM">course playlist</a> and official course site remain authoritative for what was taught. These are independent study chapters, not official CMU course notes, and they are not endorsed by Carnegie Mellon University or the instructors. The repository does not redistribute captions or slides.</p>
...
<p>The <a href="development-journey.html">development journey</a> records the requests, revisions, failures, and checks that shaped the four chapters. The <a href="textbook-style-report.html">style study of twelve PDFs and two writing guides</a> explains the editorial methods used in the chapters. The <a href="2026-09-12-writing-revision.html">writing-revision record</a> shows every changed passage from the four-chapter style audit in before-and-after form.</p>
